...
def load_csv_data(file_path):
    """Load CSV data, automatically detecting file encoding and limiting to 800 rows."""
    ...
    print("Loading a maximum of 800 rows for performance optimization...")
    return pd.read_csv(file_path, encoding=detected_encoding, nrows=800)
